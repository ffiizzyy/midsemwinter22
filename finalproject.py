...
if page == 'Help me choose a property':
    ...
    if min_guest_calc != max_guest_calc:
        num_of_guests = st.sidebar.slider('Number of guests:', min_guest_calc, max_guest_calc)
    else:
    ...
    if min_price_calc != max_price_calc:
        max_price = st.sidebar.slider('Maximum price per night:', min_price_calc, max_price_calc)
    else: 
